  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Foox - your one-stop job marketplace. Connect with top freelancers, find exciting projects, and foster growth with companies ready to offer jobs."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Foox - your one-stop job marketplace. Connect with top freelancers, find exciting projects, and foster growth with companies ready to offer jobs.`}
            </Text>
            <Box
